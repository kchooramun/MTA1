$(document).ready(function(){
	$.getJSON('https://api.foursquare.com/v2/venues/explore?near=mauritius&categoryId=4bf58dd8d48988d1fa931735&venuePhotos=1&client_id=34PUIGBQZRB5WPOZW5YZKRWI4OMYL4VCBSUTCLIP20J3LFXH&client_secret=SZHKUKYCQ1SUNPBFR1UBQQAUGZXEMHFXG3Y3ZVXQ3I5B34WH&v=20161016', function(data) {
	...
	$.getJSON('https://api.foursquare.com/v2/venues/explore?near=mauritius&categoryId=4d4b7105d754a06374d81259&venuePhotos=1&client_id=34PUIGBQZRB5WPOZW5YZKRWI4OMYL4VCBSUTCLIP20J3LFXH&client_secret=SZHKUKYCQ1SUNPBFR1UBQQAUGZXEMHFXG3Y3ZVXQ3I5B34WH&v=20161016', function(data) {

		for (var j = 0; j < `${data.response.groups[0].items}`.length; j++) {
	...
	$.getJSON('https://api.foursquare.com/v2/venues/explore?near=mauritius&categoryId=4d4b7104d754a06370d81259&venuePhotos=1&client_id=34PUIGBQZRB5WPOZW5YZKRWI4OMYL4VCBSUTCLIP20J3LFXH&client_secret=SZHKUKYCQ1SUNPBFR1UBQQAUGZXEMHFXG3Y3ZVXQ3I5B34WH&v=20161016', function(data) {

		for (var k = 0; k < `${data.response.groups[0].items}`.length; k++) {
